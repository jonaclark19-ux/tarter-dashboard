...
- **App:** `yardmap.html` → se publica en `https://TU-SITIO.netlify.app/yardmap.html`
- **Dashboard existente:** `index.html` (no se tocó) → `https://TU-SITIO.netlify.app/`
...
Si abres `yardmap.html` sin Netlify (doble clic, o un servidor sin funciones), la app
...
```
yardmap.html                 marcado de la app
