...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      "tile.searchImage": "🔍 Find photo",
      "tile.searchImageHelp": "<b>1.</b> Tap “Find photo” — it opens a Google Images search for this SKU in a new tab.<br><b>2.</b> Find the right product, tap the image, then copy its image address.<br><b>3.</b> Come back here, tap “Set photo” and paste it.",
    ...
    es: {
      ...
      "tile.searchImage": "🔍 Buscar imagen",
      "tile.searchImageHelp": "<b>1.</b> Toca “Buscar imagen” — abre una búsqueda en Google Imágenes de este SKU en otra pestaña.<br><b>2.</b> Ubica el producto correcto, toca la imagen y copia la dirección de la imagen.<br><b>3.</b> Regresa aquí, toca “Poner foto” y pégala.",
